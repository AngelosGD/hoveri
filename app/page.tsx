      ...
      <section className="relative flex flex-1 flex-col items-center justify-center px-6 pt-24 pb-24 text-center">
        ...
        <div className="mt-8 flex flex-col items-center gap-3 sm:flex-row">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex h-11 items-center gap-2 rounded-full bg-zinc-950 px-6 text-sm font-medium text-white transition-shadow hover:shadow-md"
          >
            <GitHubIcon size={16} />
            Ver en GitHub
          </a>
          <Link
            href="/icons"
            className="inline-flex h-11 items-center justify-center rounded-full border border-zinc-200 bg-white px-6 text-sm font-medium text-zinc-800 transition-colors hover:border-rose-300 hover:text-rose-600"
          >
            Ir a la librería
          </Link>
        </div>
