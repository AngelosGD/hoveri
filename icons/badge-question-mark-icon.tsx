...
const BadgeQuestionMarkIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        ...
        <motion.path className="part-1" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3" />
        <motion.line className="part-2" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} x1="12" x2="12.01" y1="17" y2="17" />
      </motion.svg>
    );
  },
);
...
export default BadgeQuestionMarkIcon;
