...
const FileQuestionMarkIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        ...
        <motion.path className="part-2" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M9.1 9a3 3 0 0 1 5.82 1c0 2-3 3-3 3" />
      </motion.svg>
    );
  },
);
...
export default FileQuestionMarkIcon;
