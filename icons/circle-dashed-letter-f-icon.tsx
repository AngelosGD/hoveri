...
const CircleDashedLetterFIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
...
CircleDashedLetterFIcon.displayName = "CircleDashedLetterFIcon";

export default CircleDashedLetterFIcon;
