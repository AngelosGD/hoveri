...
const Filter2DownIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        ...
        <motion.path className="part-4" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M19 22l3 -3" />
        <motion.path className="part-5" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M19 22l-3 -3" />
      </motion.svg>
    );
  },
);

Filter2DownIcon.displayName = "Filter2DownIcon";

export default Filter2DownIcon;
