...
const Error404Icon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    animate(".part-4", {"x":[0,-1.2680412371134022,0.7608247422680413,0],"y":[0,-2,2,0]}, { duration: 1.1, ease: "easeInOut", delay: 0.52 });
    };
    ...
    return (
      ...
      >
        ...
        <motion.path className="part-4" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M10 10v4a2 2 0 1 0 4 0v-4a2 2 0 1 0 -4 0" />
      </motion.svg>
    );
  },
);
