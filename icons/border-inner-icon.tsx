...
const BorderInnerIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    animate(".part-7", {"x":[0,-1.036082474226804,0],"y":[0,-0.4948453608247423,0]}, { duration: 1.2, ease: "easeInOut", delay: 0.84 });
    animate(".part-8", {"x":[0,-1.0051546391752577,0],"y":[0,-0.5257731958762886,0]}, { duration: 1.2, ease: "easeInOut", delay: 0.96 });
    animate(".part-9", {"x":[0,-0.9742268041237114,0],"y":[0,-0.5567010309278351,0]}, { duration: 1.2, ease: "easeInOut", delay: 1.08 });
    animate(".part-10", {"x":[0,-0.9432989690721649,0],"y":[0,-0.5876288659793815,0]}, { duration: 1.2, ease: "easeInOut", delay: 1.2 });
    animate(".part-11", {"x":[0,-0.9123711340206186,0],"y":[0,-0.6185567010309279,0]}, { duration: 1.2, ease: "easeInOut", delay: 1.3199999999999998 });
    animate(".part-12", {"x":[0,-0.8814432989690721,0],"y":[0,-0.6494845360824743,0]}, { duration: 1.2, ease: "easeInOut", delay: 1.44 });
    animate(".part-13", {"x":[0,-0.8505154639175257,0],"y":[0,-0.6804123711340206,0]}, { duration: 1.2, ease: "easeInOut", delay: 1.56 });
    };
    ...
    return (
      ...
      >
        ...
        <motion.path className="part-1" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M12 4l0 16" />
        <motion.path className="part-2" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M4 4l0 .01" />
        <motion.path className="part-3" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M8 4l0 .01" />
        ...
        <motion.path className="part-8" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M4 16l0 .01" />
        <motion.path className="part-9" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M20 16l0 .01" />
        <motion.path className="part-10" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M4 20l0 .01" />
        <motion.path className="part-11" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M8 20l0 .01" />
        <motion.path className="part-12" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M16 20l0 .01" />
        <motion.path className="part-13" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M20 20l0 .01" />
      </motion.svg>
    );
  },
);
