...
const AlignBoxLeftBottomIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        ...
        <motion.path className="part-2" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M13 14h-6" />
        <motion.path className="part-3" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M11 11h-4" />
      </motion.svg>
    );
  },
);

AlignBoxLeftBottomIcon.displayName = "AlignBoxLeftBottomIcon";
