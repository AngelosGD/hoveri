...
const CircleDottedLetterTIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
...
CircleDottedLetterTIcon.displayName = "CircleDottedLetterTIcon";

export default CircleDottedLetterTIcon;
