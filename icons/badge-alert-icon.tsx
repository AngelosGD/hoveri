...
const BadgeAlertIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    animate(".part-0", {"y":[0,0.2027999999999995,0],"opacity":[0.3,1,1]}, { duration: 0.8, ease: "easeInOut" });
    animate(".part-1", {"y":[0,394,0],"opacity":[0.3,1,1]}, { duration: 0.8, ease: "easeInOut", delay: 0.1 });
    animate(".part-2", {"y":[0,796,0],"opacity":[0.3,1,1]}, { duration: 0.8, ease: "easeInOut", delay: 0.2 });
    };
