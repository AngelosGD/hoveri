...
const ChartBarBigIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        ...
        <motion.rect className="part-1" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} x="7" y="13" width="9" height="4" rx="1" />
        <motion.rect className="part-2" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} x="7" y="5" width="12" height="4" rx="1" />
      </motion.svg>
    );
  },
);
...
export default ChartBarBigIcon;
