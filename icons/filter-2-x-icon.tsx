...
const Filter2XIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        ...
        <motion.path className="part-3" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M22 22l-5 -5m0 5l5 -5" />
      </motion.svg>
    );
  },
);

Filter2XIcon.displayName = "Filter2XIcon";

export default Filter2XIcon;
