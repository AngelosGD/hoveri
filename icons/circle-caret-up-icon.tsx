...
const CircleCaretUpIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      <motion.svg
        ...
        aria-hidden="true"
      >
        <motion.path className="part-0" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M12 9l4 4h-8l4 -4" />
...
CircleCaretUpIcon.displayName = "CircleCaretUpIcon";
