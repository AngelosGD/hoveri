...
const AdjustmentsCheckIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        ...
        <motion.path className="part-3" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M13.823 15.176a2 2 0 1 0 -2.638 2.651" />
        ...
        <motion.path className="part-7" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M18 9v5" />
        <motion.path className="part-8" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M15 19l2 2l4 -4" />
      </motion.svg>
    );
  },
);

AdjustmentsCheckIcon.displayName = "AdjustmentsCheckIcon";
