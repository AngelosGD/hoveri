...
const AppWindowBottomLeftIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        ...
        <motion.path className="part-1" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M6 14h2v2h-2v-2" fill="currentColor" />
      </motion.svg>
    );
  },
);

AppWindowBottomLeftIcon.displayName = "AppWindowBottomLeftIcon";

export default AppWindowBottomLeftIcon;
