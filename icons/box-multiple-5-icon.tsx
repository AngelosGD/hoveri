...
const BoxMultiple5Icon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        ...
        <motion.path className="part-1" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M12 14h2a2 2 0 1 0 0 -4h-2v-4h4" />
...
BoxMultiple5Icon.displayName = "BoxMultiple5Icon";
