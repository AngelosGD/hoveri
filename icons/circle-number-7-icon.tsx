...
const CircleNumber7Icon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        ...
        <motion.path className="part-1" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M10 8h4l-2 8" />
      </motion.svg>
    );
  },
);

CircleNumber7Icon.displayName = "CircleNumber7Icon";
