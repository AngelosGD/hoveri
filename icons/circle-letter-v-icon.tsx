...
const CircleLetterVIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        ...
        <motion.path className="part-1" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M10 8l2 8l2 -8" />
      </motion.svg>
    );
  },
);

CircleLetterVIcon.displayName = "CircleLetterVIcon";
