...
const CopyMinusIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      <motion.svg
        ...
        aria-hidden="true"
      >
        <motion.line className="part-0" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} x1="12" x2="18" y1="15" y2="15" />
