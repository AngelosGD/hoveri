...
const CircleLetterZIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        ...
        <motion.path className="part-1" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M10 8h4l-4 8h4" />
      </motion.svg>
    );
  },
);

CircleLetterZIcon.displayName = "CircleLetterZIcon";
