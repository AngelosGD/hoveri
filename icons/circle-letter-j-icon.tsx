...
const CircleLetterJIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        ...
        <motion.path className="part-1" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M10 8h4v6a2 2 0 1 1 -4 0" />
      </motion.svg>
    );
  },
);

CircleLetterJIcon.displayName = "CircleLetterJIcon";
