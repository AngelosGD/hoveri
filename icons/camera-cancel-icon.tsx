...
const CameraCancelIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        ...
        <motion.path className="part-1" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M14.984 13.307a3 3 0 1 0 -2.32 2.62" />
...
CameraCancelIcon.displayName = "CameraCancelIcon";
