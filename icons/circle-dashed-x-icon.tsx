...
const CircleDashedXIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        ...
        <motion.path className="part-8" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M14 14l-4 -4" />
        <motion.path className="part-9" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M10 14l4 -4" />
      </motion.svg>
    );
  },
);

CircleDashedXIcon.displayName = "CircleDashedXIcon";
