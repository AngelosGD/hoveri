...
const CircleRectangleOffIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      <motion.svg
        ...
        aria-hidden="true"
      >
        <motion.path className="part-0" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M14 10h3v3m-3 1h-7v-4h3" />
...
CircleRectangleOffIcon.displayName = "CircleRectangleOffIcon";
