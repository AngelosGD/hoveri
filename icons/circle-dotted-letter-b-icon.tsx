...
const CircleDottedLetterBIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
...
CircleDottedLetterBIcon.displayName = "CircleDottedLetterBIcon";

export default CircleDottedLetterBIcon;
