...
const ListOrderedIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    animate(".part-3", {"y":[0,1.5833333333333333,0],"opacity":[0.3,1,1]}, { duration: 0.8, ease: "easeInOut", delay: 0.30000000000000004 });
    animate(".part-4", {"y":[0,0.75,0],"opacity":[0.3,1,1]}, { duration: 0.8, ease: "easeInOut", delay: 0.4 });
