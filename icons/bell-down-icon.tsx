...
const BellDownIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        ...
        <motion.path className="part-1" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M9 17v1a3 3 0 0 0 3.518 2.955" />
...
BellDownIcon.displayName = "BellDownIcon";
