...
const Filter2PauseIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        ...
        <motion.path className="part-2" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M9 18h4" />
...
Filter2PauseIcon.displayName = "Filter2PauseIcon";

export default Filter2PauseIcon;
