...
const ArrowLeftDashedIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      <motion.svg
        ...
        aria-hidden="true"
      >
        <motion.path className="part-0" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M5 12h6m3 0h1.5m3 0h.5" />
        <motion.path className="part-1" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M5 12l6 6" />
        <motion.path className="part-2" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M5 12l6 -6" />
      </motion.svg>
    );
  },
);

ArrowLeftDashedIcon.displayName = "ArrowLeftDashedIcon";

export default ArrowLeftDashedIcon;
