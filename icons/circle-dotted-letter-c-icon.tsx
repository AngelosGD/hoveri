...
const CircleDottedLetterCIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    animate(".part-10", {"opacity":[1,0.55,1],"scale":[1,1.06,1]}, { duration: 1, ease: "easeInOut", delay: 1.5 });
    animate(".part-11", {"opacity":[1,0.55,1],"scale":[1,1.06,1]}, { duration: 1, ease: "easeInOut", delay: 1.65 });
    animate(".part-12", {"opacity":[1,0.55,1],"scale":[1,1.06,1]}, { duration: 1, ease: "easeInOut", delay: 1.7999999999999998 });
    };
    ...
    return (
      <motion.svg
        ...
        aria-hidden="true"
      >
        <motion.path className="part-0" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M14 10a2 2 0 1 0 -4 0v4a2 2 0 1 0 4 0" />
...
CircleDottedLetterCIcon.displayName = "CircleDottedLetterCIcon";

export default CircleDottedLetterCIcon;
