...
const AdjustmentsCodeIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    animate(".part-9", {"opacity":[1,0.2,1]}, { duration: 0.3, ease: "easeInOut", delay: 1.08 });
    animate(".part-10", {"opacity":[1,0.2,1]}, { duration: 0.3, ease: "easeInOut", delay: 1.2 });
    };
    ...
    return (
      ...
      >
        ...
        <motion.path className="part-3" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M13.557 14.745a2 2 0 1 0 -1.557 3.255" />
        ...
        <motion.path className="part-9" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M20 21l2 -2l-2 -2" />
        <motion.path className="part-10" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M17 17l-2 2l2 2" />
      </motion.svg>
    );
  },
);

AdjustmentsCodeIcon.displayName = "AdjustmentsCodeIcon";
