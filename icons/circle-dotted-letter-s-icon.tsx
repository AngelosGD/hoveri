...
const CircleDottedLetterSIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
...
CircleDottedLetterSIcon.displayName = "CircleDottedLetterSIcon";

export default CircleDottedLetterSIcon;
