...
const DeviceIpadHorizontalPlusIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
...
DeviceIpadHorizontalPlusIcon.displayName = "DeviceIpadHorizontalPlusIcon";
