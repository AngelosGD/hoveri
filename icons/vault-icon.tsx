...
const VaultIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        ...
        <motion.path className="part-2" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="m7.9 7.9 2.7 2.7" />
        <motion.circle className="part-3" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} cx="16.5" cy="7.5" r=".5" fill="currentColor" />
        <motion.path className="part-4" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="m13.4 10.6 2.7-2.7" />
        <motion.circle className="part-5" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} cx="7.5" cy="16.5" r=".5" fill="currentColor" />
        <motion.path className="part-6" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="m7.9 16.1 2.7-2.7" />
        <motion.circle className="part-7" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} cx="16.5" cy="16.5" r=".5" fill="currentColor" />
        <motion.path className="part-8" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="m13.4 13.4 2.7 2.7" />
        <motion.circle className="part-9" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} cx="12" cy="12" r="2" />
      </motion.svg>
    );
  },
);
