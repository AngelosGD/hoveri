...
const CircleDottedLetterVIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
...
CircleDottedLetterVIcon.displayName = "CircleDottedLetterVIcon";

export default CircleDottedLetterVIcon;
