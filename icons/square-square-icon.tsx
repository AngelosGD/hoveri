...
const SquareSquareIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        ...
        <motion.rect className="part-1" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} x="8" y="8" width="8" height="8" rx="1" />
      </motion.svg>
    );
  },
);
