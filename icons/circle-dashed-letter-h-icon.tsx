...
const CircleDashedLetterHIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
...
CircleDashedLetterHIcon.displayName = "CircleDashedLetterHIcon";

export default CircleDashedLetterHIcon;
