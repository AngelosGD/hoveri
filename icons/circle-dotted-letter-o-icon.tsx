...
const CircleDottedLetterOIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
...
CircleDottedLetterOIcon.displayName = "CircleDottedLetterOIcon";

export default CircleDottedLetterOIcon;
