...
const BrandProducthuntIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      <motion.svg
        ...
        aria-hidden="true"
      >
        <motion.path className="part-0" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M10 16v-8h2.5a2.5 2.5 0 1 1 0 5h-2.5" />
...
BrandProducthuntIcon.displayName = "BrandProducthuntIcon";
