...
const AppWindowBottomRightIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        ...
        <motion.path className="part-1" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M16 14h2v2h-2v-2" fill="currentColor" />
      </motion.svg>
    );
  },
);

AppWindowBottomRightIcon.displayName = "AppWindowBottomRightIcon";

export default AppWindowBottomRightIcon;
