...
const CircleDashedLetterTIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
...
CircleDashedLetterTIcon.displayName = "CircleDashedLetterTIcon";

export default CircleDashedLetterTIcon;
