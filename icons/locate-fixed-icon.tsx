...
const LocateFixedIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    animate(".part-1", {"scale":[1,1.06,1]}, { duration: 0.9, ease: "easeInOut" });
    ...
    animate(".part-5", {"scale":[1,1.06,1]}, { duration: 0.9, ease: "easeInOut" });
    };
    ...
    return (
      ...
      >
        ...
        <motion.circle className="part-5" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} cx="12" cy="12" r="3" />
      </motion.svg>
    );
  },
);
