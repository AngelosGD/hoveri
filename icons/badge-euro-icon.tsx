...
const BadgeEuroIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        ...
        <motion.path className="part-2" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M15 9.4a4 4 0 1 0 0 5.2" />
      </motion.svg>
    );
  },
);
