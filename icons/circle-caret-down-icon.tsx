...
const CircleCaretDownIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        ...
        <motion.path className="part-1" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M12 15l-4 -4h8l-4 4" />
      </motion.svg>
    );
  },
);

CircleCaretDownIcon.displayName = "CircleCaretDownIcon";
