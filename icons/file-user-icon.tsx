...
const FileUserIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        ...
        <motion.path className="part-2" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M16 22a4 4 0 0 0-8 0" />
        <motion.circle className="part-3" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} cx="12" cy="15" r="3" />
      </motion.svg>
    );
  },
);

FileUserIcon.displayName = "FileUserIcon";
