...
const CircleDottedLetterUIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
...
CircleDottedLetterUIcon.displayName = "CircleDottedLetterUIcon";

export default CircleDottedLetterUIcon;
