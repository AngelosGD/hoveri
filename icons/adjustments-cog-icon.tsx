...
const AdjustmentsCogIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        ...
        <motion.path className="part-3" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M13.199 14.399a2 2 0 1 0 -1.199 3.601" />
        ...
        <motion.path className="part-8" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M18 9v2.5" />
        <motion.path className="part-9" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M17.001 19a2 2 0 1 0 4 0a2 2 0 1 0 -4 0" />
        <motion.path className="part-10" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M19.001 15.5v1.5" />
        <motion.path className="part-11" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M19.001 21v1.5" />
        <motion.path className="part-12" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M22.032 17.25l-1.299 .75" />
        <motion.path className="part-13" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M17.27 20l-1.3 .75" />
        <motion.path className="part-14" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M15.97 17.25l1.3 .75" />
        <motion.path className="part-15" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M20.733 20l1.3 .75" />
      </motion.svg>
    );
  },
);

AdjustmentsCogIcon.displayName = "AdjustmentsCogIcon";
