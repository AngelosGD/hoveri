  ...
  (
    ...
    return (
      ...
      >
        ...
        <motion.line className="part-1" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} x1="22" x2="18" y1="12" y2="12" />
        <motion.line className="part-2" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} x1="6" x2="2" y1="12" y2="12" />
        <motion.line className="part-3" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} x1="12" x2="12" y1="6" y2="2" />
        <motion.line className="part-4" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} x1="12" x2="12" y1="22" y2="18" />
      </motion.svg>
    );
  },
);
