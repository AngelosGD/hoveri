...
const MedalIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    animate(".part-0", {"opacity":[1,0.55,1],"scale":[1,1.07,1],"rotate":[0,2.804123711340206,0]}, { duration: 1, ease: "easeInOut" });
    animate(".part-1", {"opacity":[1,0.55,1],"scale":[1,1.07,1],"rotate":[0,2.88659793814433,0]}, { duration: 1, ease: "easeInOut", delay: 0.15 });
    animate(".part-2", {"opacity":[1,0.55,1],"scale":[1,1.07,1],"rotate":[0,2.9690721649484537,0]}, { duration: 1, ease: "easeInOut", delay: 0.3 });
    animate(".part-3", {"opacity":[1,0.55,1],"scale":[1,1.07,1],"rotate":[0,3.051546391752577,0]}, { duration: 1, ease: "easeInOut", delay: 0.44999999999999996 });
    animate(".part-4", {"opacity":[1,0.55,1],"scale":[1,1.07,1],"rotate":[0,3.134020618556701,0]}, { duration: 1, ease: "easeInOut", delay: 0.6 });
    animate(".part-5", {"opacity":[1,0.55,1],"scale":[1,1.07,1],"rotate":[0,3.216494845360825,0]}, { duration: 1, ease: "easeInOut", delay: 0.75 });
    };
