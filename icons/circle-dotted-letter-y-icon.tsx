...
const CircleDottedLetterYIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
...
CircleDottedLetterYIcon.displayName = "CircleDottedLetterYIcon";

export default CircleDottedLetterYIcon;
