...
const CircleCaretRightIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      <motion.svg
        ...
        aria-hidden="true"
      >
        <motion.path className="part-0" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M15 12l-4 -4v8l4 -4" />
...
CircleCaretRightIcon.displayName = "CircleCaretRightIcon";
