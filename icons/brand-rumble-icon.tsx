...
const BrandRumbleIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    animate(".part-0", {"x":[0,-0.7577319587628866,0],"y":[0,-0.7731958762886597,0]}, { duration: 1.2, ease: "easeInOut" });
    animate(".part-1", {"x":[0,-0.7268041237113403,0],"y":[0,-0.8041237113402062,0]}, { duration: 1.2, ease: "easeInOut", delay: 0.12 });
    };
