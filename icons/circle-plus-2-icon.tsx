...
const CirclePlus2Icon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      <motion.svg
        ...
        aria-hidden="true"
      >
        <motion.path className="part-0" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M20.985 12.522a9 9 0 1 0 -8.475 8.464" />
...
CirclePlus2Icon.displayName = "CirclePlus2Icon";
