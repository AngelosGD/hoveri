...
const CircleDottedLetterJIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
...
CircleDottedLetterJIcon.displayName = "CircleDottedLetterJIcon";

export default CircleDottedLetterJIcon;
