...
const AudioLinesXIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    animate(".part-6", {"y":[0,-5,1.5,-0.5,0],"scale":[1,0.9,1.04,1]}, { duration: 0.9, ease: "easeInOut", delay: 0.6000000000000001 });
    animate(".part-7", {"y":[0,-5,1.5,-0.5,0],"scale":[1,0.9,1.04,1]}, { duration: 0.9, ease: "easeInOut", delay: 0.7000000000000001 });
    };
