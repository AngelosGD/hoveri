...
const CircleDottedLetterWIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
...
CircleDottedLetterWIcon.displayName = "CircleDottedLetterWIcon";

export default CircleDottedLetterWIcon;
