...
const ChartColumnBigIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        ...
        <motion.rect className="part-1" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} x="15" y="5" width="4" height="12" rx="1" />
        <motion.rect className="part-2" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} x="7" y="8" width="4" height="9" rx="1" />
      </motion.svg>
    );
  },
);
