...
const CircleLetterCIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        ...
        <motion.path className="part-1" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M14 10a2 2 0 1 0 -4 0v4a2 2 0 1 0 4 0" />
      </motion.svg>
    );
  },
);

CircleLetterCIcon.displayName = "CircleLetterCIcon";
