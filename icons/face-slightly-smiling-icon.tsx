...
const FaceSlightlySmilingIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        ...
        <motion.path className="part-1" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M16.472 15a6 6 0 01-8.943 0" />
...
FaceSlightlySmilingIcon.displayName = "FaceSlightlySmilingIcon";

export default FaceSlightlySmilingIcon;
