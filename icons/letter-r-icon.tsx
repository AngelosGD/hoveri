...
const RLetterIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        ...
        <motion.path className="part-1" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M8 14l7 6" />
      </motion.svg>
    );
  },
);

RLetterIcon.displayName = "RLetterIcon";

export default RLetterIcon;
