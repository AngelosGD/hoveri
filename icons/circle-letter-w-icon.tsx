...
const CircleLetterWIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        ...
        <motion.path className="part-1" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M9 8l1 8l2 -5l2 5l1 -8" />
      </motion.svg>
    );
  },
);

CircleLetterWIcon.displayName = "CircleLetterWIcon";
