...
const AdjustmentsCancelIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    animate(".part-8", {"opacity":[1,0.35,1],"x":[0,0.20618556701030943,0]}, { duration: 0.9, ease: "easeInOut", delay: 0.96 });
    animate(".part-9", {"opacity":[1,0.35,1],"x":[0,0.28865979381443285,0]}, { duration: 0.9, ease: "easeInOut", delay: 1.08 });
    animate(".part-10", {"opacity":[1,0.35,1],"x":[0,0.37113402061855627,0]}, { duration: 0.9, ease: "easeInOut", delay: 1.2 });
    };
    ...
    return (
      ...
      >
        ...
        <motion.path className="part-3" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M13.499 14.675a2 2 0 1 0 -1.499 3.325" />
        ...
        <motion.path className="part-9" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M16 19a3 3 0 1 0 6 0a3 3 0 1 0 -6 0" />
        <motion.path className="part-10" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M17 21l4 -4" />
      </motion.svg>
    );
  },
);

AdjustmentsCancelIcon.displayName = "AdjustmentsCancelIcon";
