...
const CircleDashedNumber0Icon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    animate(".part-1", {"x":[0,-1.0206185567010309,0.6123711340206185,0],"y":[0,-2,2,0]}, { duration: 1.1, ease: "easeInOut", delay: 0.13 });
    animate(".part-2", {"x":[0,-0.9587628865979381,0.5752577319587628,0],"y":[0,-2,2,0]}, { duration: 1.1, ease: "easeInOut", delay: 0.26 });
    animate(".part-3", {"x":[0,-0.8969072164948455,0.5381443298969073,0],"y":[0,-2,2,0]}, { duration: 1.1, ease: "easeInOut", delay: 0.39 });
    animate(".part-4", {"x":[0,-0.8350515463917526,0.5010309278350515,0],"y":[0,-2,2,0]}, { duration: 1.1, ease: "easeInOut", delay: 0.52 });
    animate(".part-5", {"x":[0,-0.7731958762886597,0.4639175257731958,0],"y":[0,-2,2,0]}, { duration: 1.1, ease: "easeInOut", delay: 0.65 });
    animate(".part-6", {"x":[0,-0.7113402061855671,0.4268041237113403,0],"y":[0,-2,2,0]}, { duration: 1.1, ease: "easeInOut", delay: 0.78 });
    animate(".part-7", {"x":[0,-0.6494845360824743,0.38969072164948454,0],"y":[0,-2,2,0]}, { duration: 1.1, ease: "easeInOut", delay: 0.91 });
    ...
    return (
      ...
      >
        ...
        <motion.path className="part-8" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M10 10v4a2 2 0 1 0 4 0v-4a2 2 0 1 0 -4 0" />
      </motion.svg>
    );
  },
);

CircleDashedNumber0Icon.displayName = "CircleDashedNumber0Icon";
