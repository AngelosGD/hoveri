...
const CircleDottedLetterHIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    animate(".part-12", {"opacity":[1,0.35,1],"x":[0,1.0309278350515463,0]}, { duration: 0.9, ease: "easeInOut", delay: 1.44 });
    animate(".part-13", {"opacity":[1,0.35,1],"x":[0,1.1134020618556697,0]}, { duration: 0.9, ease: "easeInOut", delay: 1.56 });
    };
    ...
    return (
      <motion.svg
        ...
        aria-hidden="true"
      >
        <motion.path className="part-0" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M10 16v-8m4 0v8" />
        <motion.path className="part-1" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M10 12h4" />
...
CircleDottedLetterHIcon.displayName = "CircleDottedLetterHIcon";

export default CircleDottedLetterHIcon;
