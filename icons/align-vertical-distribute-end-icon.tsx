...
const AlignVerticalDistributeEndIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        ...
        <motion.path className="part-3" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M2 10h20" />
      </motion.svg>
    );
  },
);

AlignVerticalDistributeEndIcon.displayName = "AlignVerticalDistributeEndIcon";
