...
const Filter2ExclamationIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        ...
        <motion.path className="part-2" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M9 18h6" />
        <motion.path className="part-3" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M19 16v3m0 3v.01" />
      </motion.svg>
    );
  },
);

Filter2ExclamationIcon.displayName = "Filter2ExclamationIcon";

export default Filter2ExclamationIcon;
