...
const CircleDashedLetterXIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
...
CircleDashedLetterXIcon.displayName = "CircleDashedLetterXIcon";

export default CircleDashedLetterXIcon;
