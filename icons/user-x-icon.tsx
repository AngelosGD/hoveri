  ...
  (
    ...
    return (
      ...
      >
        ...
        <motion.line className="part-2" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} x1="17" x2="22" y1="8" y2="13" />
        <motion.line className="part-3" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} x1="22" x2="17" y1="8" y2="13" />
      </motion.svg>
    );
  },
);
