...
const CircleDottedLetterGIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
...
CircleDottedLetterGIcon.displayName = "CircleDottedLetterGIcon";

export default CircleDottedLetterGIcon;
