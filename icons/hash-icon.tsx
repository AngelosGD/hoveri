  ...
  (
    ...
    return (
      <motion.svg
        ...
        aria-hidden="true"
      >
        <motion.line className="part-0" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} x1="4" x2="20" y1="9" y2="9" />
        <motion.line className="part-1" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} x1="4" x2="20" y1="15" y2="15" />
        <motion.line className="part-2" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} x1="10" x2="8" y1="3" y2="21" />
        <motion.line className="part-3" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} x1="16" x2="14" y1="3" y2="21" />
      </motion.svg>
    );
  },
);
