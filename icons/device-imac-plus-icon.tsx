...
const DeviceImacPlusIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        ...
        <motion.path className="part-1" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M3 13h13.5" />
...
DeviceImacPlusIcon.displayName = "DeviceImacPlusIcon";
