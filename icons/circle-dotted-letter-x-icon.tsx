...
const CircleDottedLetterXIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    animate(".part-4", {"x":[0,0.6340206185567011,0],"y":[0,-2.1649484536082473,0]}, { duration: 1.2, ease: "easeInOut", delay: 0.48 });
    animate(".part-5", {"x":[0,0.6649484536082474,0],"y":[0,-2.1958762886597936,0]}, { duration: 1.2, ease: "easeInOut", delay: 0.6 });
    animate(".part-6", {"x":[0,0.6958762886597937,0],"y":[0,-2.2268041237113403,0]}, { duration: 1.2, ease: "easeInOut", delay: 0.72 });
    animate(".part-7", {"x":[0,0.7268041237113403,0],"y":[0,-2.2577319587628866,0]}, { duration: 1.2, ease: "easeInOut", delay: 0.84 });
    animate(".part-8", {"x":[0,0.7577319587628866,0],"y":[0,-2.288659793814433,0]}, { duration: 1.2, ease: "easeInOut", delay: 0.96 });
    animate(".part-9", {"x":[0,0.7886597938144329,0],"y":[0,-2.3195876288659796,0]}, { duration: 1.2, ease: "easeInOut", delay: 1.08 });
    animate(".part-10", {"x":[0,0.8195876288659795,0],"y":[0,-2.350515463917526,0]}, { duration: 1.2, ease: "easeInOut", delay: 1.2 });
    animate(".part-11", {"x":[0,0.8505154639175257,0],"y":[0,-2.381443298969072,0]}, { duration: 1.2, ease: "easeInOut", delay: 1.3199999999999998 });
    animate(".part-12", {"x":[0,0.881443298969072,0],"y":[0,-2.412371134020619,0]}, { duration: 1.2, ease: "easeInOut", delay: 1.44 });
    animate(".part-13", {"x":[0,0.9123711340206186,0],"y":[0,-2.443298969072165,0]}, { duration: 1.2, ease: "easeInOut", delay: 1.56 });
    };
    ...
    return (
      <motion.svg
        ...
        aria-hidden="true"
      >
        <motion.path className="part-0" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M10 8l4 8" />
        <motion.path className="part-1" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M10 16l4 -8" />
...
CircleDottedLetterXIcon.displayName = "CircleDottedLetterXIcon";

export default CircleDottedLetterXIcon;
