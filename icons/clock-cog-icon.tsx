...
const ClockCogIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    animate(".part-8", {"rotate":40}, { duration: 1.1, ease: "easeInOut", delay: 0.1 });
    ...
    return (
      <motion.svg
        ...
        aria-hidden="true"
      >
        <motion.path className="part-0" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M21 12a9 9 0 1 0 -9.002 9" />
        ...
        <motion.path className="part-8" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M12 7v5l2 2" />
      </motion.svg>
    );
  },
);

ClockCogIcon.displayName = "ClockCogIcon";
