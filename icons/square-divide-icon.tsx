...
const SquareDivideIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        ...
        <motion.line className="part-1" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} x1="8" x2="16" y1="12" y2="12" />
        <motion.line className="part-2" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} x1="12" x2="12" y1="16" y2="16" />
        <motion.line className="part-3" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} x1="12" x2="12" y1="8" y2="8" />
      </motion.svg>
    );
  },
);
