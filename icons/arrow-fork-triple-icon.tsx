...
const ArrowForkTripleIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    animate(".part-2", {"x":[0,3,0],"y":[0,0,0],"opacity":[0.6,1,1]}, { duration: 0.8, ease: "easeInOut", delay: 0.05 });
    ...
    return (
      ...
      >
        ...
        <motion.path className="part-1" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M16 7l-4 -4l-4 4" />
        <motion.path className="part-2" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M16 11h5v5" />
        <motion.path className="part-3" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M8 11h-5v5" />
        <motion.path className="part-4" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M3 11l8.293 8.293c.453 .453 .707 1.067 .707 1.707" />
        <motion.path className="part-5" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M21 11l-8.293 8.293a2.4 2.4 0 0 0 -.707 1.707" />
      </motion.svg>
    );
  },
);

ArrowForkTripleIcon.displayName = "ArrowForkTripleIcon";

export default ArrowForkTripleIcon;
