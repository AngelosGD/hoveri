...
const BadgeRussianRubleIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        ...
        <motion.path className="part-1" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M9 16h5" />
        <motion.path className="part-2" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M9 12h5a2 2 0 1 0 0-4h-3v9" />
      </motion.svg>
    );
  },
);

BadgeRussianRubleIcon.displayName = "BadgeRussianRubleIcon";
