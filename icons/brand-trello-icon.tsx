...
const BrandTrelloIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        ...
        <motion.path className="part-1" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M7 7h3v10h-3l0 -10" />
        <motion.path className="part-2" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M14 7h3v6h-3l0 -6" />
      </motion.svg>
    );
  },
);

BrandTrelloIcon.displayName = "BrandTrelloIcon";
