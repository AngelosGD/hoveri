...
const MonitorStopIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        ...
        <motion.rect className="part-2" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} x="2" y="3" width="20" height="14" rx="2" />
        <motion.rect className="part-3" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} x="9" y="7" width="6" height="6" rx="1" />
      </motion.svg>
    );
  },
);
