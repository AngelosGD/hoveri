...
const DeviceIpadHorizontalCodeIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        ...
        <motion.path className="part-1" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M9 17h2.5" />
...
DeviceIpadHorizontalCodeIcon.displayName = "DeviceIpadHorizontalCodeIcon";
