...
const CircleDashedLetterEIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
...
CircleDashedLetterEIcon.displayName = "CircleDashedLetterEIcon";

export default CircleDashedLetterEIcon;
