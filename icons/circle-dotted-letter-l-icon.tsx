...
const CircleDottedLetterLIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
...
CircleDottedLetterLIcon.displayName = "CircleDottedLetterLIcon";

export default CircleDottedLetterLIcon;
