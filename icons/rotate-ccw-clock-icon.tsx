...
const RotateCcwClockIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        ...
        <motion.path className="part-2" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M12 7v5l4 2" />
      </motion.svg>
    );
  },
);

RotateCcwClockIcon.displayName = "RotateCcwClockIcon";

export default RotateCcwClockIcon;
