...
const TargetIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    animate(".part-1", {"scale":[1,1.3,1]}, { duration: 0.8, ease: "easeInOut", delay: 0.05 });
    animate(".part-2", {"scale":[1,1.3,1]}, { duration: 0.8, ease: "easeInOut", delay: 0.05 });
    };
    ...
    return (
      ...
      >
        ...
        <motion.circle className="part-1" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} cx="12" cy="12" r="6" />
