...
const CalendarDueIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        ...
        <motion.path className="part-4" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M11 16a1 1 0 1 0 2 0a1 1 0 1 0 -2 0" />
      </motion.svg>
    );
  },
);

CalendarDueIcon.displayName = "CalendarDueIcon";
