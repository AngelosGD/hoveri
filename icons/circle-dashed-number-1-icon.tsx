...
const CircleDashedNumber1Icon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        ...
        <motion.path className="part-8" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M10 10l2 -2v8" />
      </motion.svg>
    );
  },
);

CircleDashedNumber1Icon.displayName = "CircleDashedNumber1Icon";
