...
const ArrowDownCircleIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        ...
        <motion.path className="part-2" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M12 7a2 2 0 1 0 0 -4a2 2 0 0 0 0 4" />
      </motion.svg>
    );
  },
);
