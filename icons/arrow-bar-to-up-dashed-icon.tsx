...
const ArrowBarToUpDashedIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        ...
        <motion.path className="part-3" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M4 4h3m13 0h-3m-3.5 0h-3" />
      </motion.svg>
    );
  },
);

ArrowBarToUpDashedIcon.displayName = "ArrowBarToUpDashedIcon";

export default ArrowBarToUpDashedIcon;
