...
const Heading6Icon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        ...
        <motion.circle className="part-3" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} cx="19" cy="16" r="2" />
        <motion.path className="part-4" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M20 10c-2 2-3 3.5-3 6" />
      </motion.svg>
    );
  },
);
