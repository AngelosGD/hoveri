...
const Filter2PlusIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        ...
        <motion.path className="part-4" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M16 18h6" />
      </motion.svg>
    );
  },
);

Filter2PlusIcon.displayName = "Filter2PlusIcon";

export default Filter2PlusIcon;
