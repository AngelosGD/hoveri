...
const CircleLetterPIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        ...
        <motion.path className="part-1" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M10 12h2a2 2 0 1 0 0 -4h-2v8" />
      </motion.svg>
    );
  },
);

CircleLetterPIcon.displayName = "CircleLetterPIcon";
