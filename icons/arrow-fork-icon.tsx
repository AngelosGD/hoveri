...
const ArrowForkIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        ...
        <motion.path className="part-1" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M8 3h-5v5" />
        <motion.path className="part-2" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M21 3l-7.536 7.536a5 5 0 0 0 -1.464 3.534v6.93" />
        <motion.path className="part-3" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M3 3l7.536 7.536a5 5 0 0 1 1.464 3.534v.93" />
      </motion.svg>
    );
  },
);

ArrowForkIcon.displayName = "ArrowForkIcon";
