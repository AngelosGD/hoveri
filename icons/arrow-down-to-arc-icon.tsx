...
const ArrowDownToArcIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        ...
        <motion.path className="part-1" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M16 11l-4 4l-4 -4" />
...
ArrowDownToArcIcon.displayName = "ArrowDownToArcIcon";
