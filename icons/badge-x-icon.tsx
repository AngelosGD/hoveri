...
const BadgeXIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        ...
        <motion.line className="part-1" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} x1="15" x2="9" y1="9" y2="15" />
        <motion.line className="part-2" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} x1="9" x2="15" y1="9" y2="15" />
      </motion.svg>
    );
  },
);

BadgeXIcon.displayName = "BadgeXIcon";
