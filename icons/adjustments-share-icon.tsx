...
const AdjustmentsShareIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    animate(".part-10", {"scale":[0.6,1.2,0.95,1]}, { duration: 0.7, ease: "easeInOut", delay: 1 });
    };
    ...
    return (
      ...
      >
        ...
        <motion.path className="part-3" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M13.387 14.56a2 2 0 1 0 -.798 3.352" />
        ...
        <motion.path className="part-8" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M16 22l5 -5" />
        <motion.path className="part-9" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M21 21.5v-4.5h-4.5" />
        <motion.path className="part-10" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M18 9v4" />
      </motion.svg>
    );
  },
);

AdjustmentsShareIcon.displayName = "AdjustmentsShareIcon";
