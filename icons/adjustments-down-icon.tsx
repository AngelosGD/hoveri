...
const AdjustmentsDownIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        ...
        <motion.path className="part-3" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M13.945 15.53a2 2 0 1 0 -1.945 2.47" />
        ...
        <motion.path className="part-9" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M19 16v6" />
...
AdjustmentsDownIcon.displayName = "AdjustmentsDownIcon";
