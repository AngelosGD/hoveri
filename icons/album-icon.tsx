...
const AlbumIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        ...
        <motion.polyline className="part-1" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} points="11 3 11 11 14 8 17 11 17 3" />
      </motion.svg>
    );
  },
);
