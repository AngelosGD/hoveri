...
const CircleLetterLIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        ...
        <motion.path className="part-1" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M10 8v8h4" />
      </motion.svg>
    );
  },
);

CircleLetterLIcon.displayName = "CircleLetterLIcon";
