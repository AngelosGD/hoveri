...
const BrandAnsibleIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        ...
        <motion.path className="part-1" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M9.647 12.294l6.353 3.706l-4 -9l-4 9" />
      </motion.svg>
    );
  },
);

BrandAnsibleIcon.displayName = "BrandAnsibleIcon";
