  ...
  (
    ...
    return (
      ...
      >
        ...
        <motion.circle className="part-1" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} cx="6" cy="18" r="3" />
        <motion.circle className="part-2" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} cx="18" cy="16" r="3" />
      </motion.svg>
    );
  },
);
