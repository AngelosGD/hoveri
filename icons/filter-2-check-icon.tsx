...
const Filter2CheckIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        ...
        <motion.path className="part-3" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M15 18l2 2l4 -4" />
      </motion.svg>
    );
  },
);

Filter2CheckIcon.displayName = "Filter2CheckIcon";

export default Filter2CheckIcon;
