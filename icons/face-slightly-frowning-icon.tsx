...
const FaceSlightlyFrowningIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        ...
        <motion.path className="part-1" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M9 10V9" />
        <motion.path className="part-2" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M9 16a5 5 0 016 0" />
...
FaceSlightlyFrowningIcon.displayName = "FaceSlightlyFrowningIcon";

export default FaceSlightlyFrowningIcon;
