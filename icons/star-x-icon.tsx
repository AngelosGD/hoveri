...
const StarXIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    animate(".part-2", {"opacity":[1,0.35,1],"x":[0,3.092783505154639,0]}, { duration: 0.9, ease: "easeInOut", delay: 0.24 });
    };
