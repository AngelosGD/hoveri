...
const FileChartColumnIncreasingIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        ...
        <motion.path className="part-2" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M8 18v-2" />
        <motion.path className="part-3" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M12 18v-4" />
        <motion.path className="part-4" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M16 18v-6" />
      </motion.svg>
    );
  },
);

FileChartColumnIncreasingIcon.displayName = "FileChartColumnIncreasingIcon";

export default FileChartColumnIncreasingIcon;
