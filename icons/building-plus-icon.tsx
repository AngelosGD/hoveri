...
const BuildingPlusIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        ...
        <motion.path className="part-7" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M16 19h6" />
        <motion.path className="part-8" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M19 16v6" />
      </motion.svg>
    );
  },
);

BuildingPlusIcon.displayName = "BuildingPlusIcon";

export default BuildingPlusIcon;
