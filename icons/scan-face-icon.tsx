...
const ScanFaceIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    animate(".part-4", {"y":[0,-6,0]}, { duration: 0.8, ease: "easeInOut", delay: 0.05 });
    animate(".part-5", {"scale":[1,1.1,1],"opacity":[1,0.5,1]}, { duration: 0.8, ease: "easeInOut", delay: 0.5 });
    animate(".part-6", {"scale":[1,1.1,1],"opacity":[1,0.5,1]}, { duration: 0.8, ease: "easeInOut", delay: 0.6000000000000001 });
    };
    ...
    return (
      ...
      >
        ...
        <motion.path className="part-4" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M8 14s1.5 2 4 2 4-2 4-2" />
        <motion.path className="part-5" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M9 9h.01" />
        <motion.path className="part-6" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M15 9h.01" />
      </motion.svg>
    );
  },
);
