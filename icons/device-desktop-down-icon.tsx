...
const DeviceDesktopDownIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        ...
        <motion.path className="part-4" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M22 19l-3 3l-3 -3" />
      </motion.svg>
    );
  },
);

DeviceDesktopDownIcon.displayName = "DeviceDesktopDownIcon";
