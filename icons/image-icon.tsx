...
const ImageIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    animate(".part-0", {"scale":[1,1.05,0.98,1]}, { duration: 0.8, ease: "easeInOut", delay: 0.05 });
    ...
    return (
      ...
      >
        ...
        <motion.circle className="part-1" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} cx="9" cy="9" r="2" />
        <motion.path className="part-2" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21" />
      </motion.svg>
    );
  },
);
