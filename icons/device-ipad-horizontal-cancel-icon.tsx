...
const DeviceIpadHorizontalCancelIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
...
DeviceIpadHorizontalCancelIcon.displayName = "DeviceIpadHorizontalCancelIcon";
