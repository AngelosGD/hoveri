...
const BrandYcombinatorIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        ...
        <motion.path className="part-1" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M8 7l4 6l4 -6" />
        <motion.path className="part-2" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M12 17l0 -4" />
      </motion.svg>
    );
  },
);

BrandYcombinatorIcon.displayName = "BrandYcombinatorIcon";
