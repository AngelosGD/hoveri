...
const CircleDottedLetterAIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
...
CircleDottedLetterAIcon.displayName = "CircleDottedLetterAIcon";

export default CircleDottedLetterAIcon;
