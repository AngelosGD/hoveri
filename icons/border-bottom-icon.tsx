...
const BorderBottomIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    animate(".part-8", {"y":[0,-1,0]}, { duration: 0.8, ease: "easeInOut", delay: 0.8 });
    animate(".part-9", {"y":[0,-1,0]}, { duration: 0.8, ease: "easeInOut", delay: 0.9 });
    animate(".part-10", {"y":[0,-1,0]}, { duration: 0.8, ease: "easeInOut", delay: 1 });
    animate(".part-11", {"y":[0,-1,0]}, { duration: 0.8, ease: "easeInOut", delay: 1.1 });
    animate(".part-12", {"y":[0,-1,0]}, { duration: 0.8, ease: "easeInOut", delay: 1.2000000000000002 });
    animate(".part-13", {"y":[0,-1,0]}, { duration: 0.8, ease: "easeInOut", delay: 1.3 });
    animate(".part-14", {"y":[0,2,0],"opacity":[1,0.5,1]}, { duration: 0.8, ease: "easeInOut", delay: 1.4000000000000001 });
    animate(".part-15", {"y":[0,2,0],"opacity":[1,0.5,1]}, { duration: 0.8, ease: "easeInOut", delay: 1.5 });
    animate(".part-16", {"y":[0,2,0],"opacity":[1,0.5,1]}, { duration: 0.8, ease: "easeInOut", delay: 1.6 });
    };
    ...
    return (
      <motion.svg
        ...
        aria-hidden="true"
      >
        <motion.path className="part-0" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M20 20l-16 0" />
        ...
        <motion.path className="part-9" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M4 12l0 .01" />
        <motion.path className="part-10" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M8 12l0 .01" />
        <motion.path className="part-11" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M12 12l0 .01" />
        <motion.path className="part-12" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M16 12l0 .01" />
        <motion.path className="part-13" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M20 12l0 .01" />
        <motion.path className="part-14" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M4 16l0 .01" />
        <motion.path className="part-15" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M12 16l0 .01" />
        <motion.path className="part-16" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M20 16l0 .01" />
      </motion.svg>
    );
  },
);
