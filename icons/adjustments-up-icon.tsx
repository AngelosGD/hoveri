...
const AdjustmentsUpIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        ...
        <motion.path className="part-3" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M13.927 15.462a2 2 0 1 0 -1.927 2.538" />
        ...
        <motion.path className="part-9" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M19 22v-6" />
        <motion.path className="part-10" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M22 19l-3 -3l-3 3" />
      </motion.svg>
    );
  },
);

AdjustmentsUpIcon.displayName = "AdjustmentsUpIcon";
