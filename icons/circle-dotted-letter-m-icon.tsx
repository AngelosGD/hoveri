...
const CircleDottedLetterMIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
...
CircleDottedLetterMIcon.displayName = "CircleDottedLetterMIcon";

export default CircleDottedLetterMIcon;
