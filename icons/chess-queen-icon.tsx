...
const ChessQueenIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      ...
      >
        ...
        <motion.path className="part-1" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="m12.474 5.943 1.567 5.34a1 1 0 0 0 1.75.328l2.616-3.402" />
        <motion.path className="part-2" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="m20 9-3 9" />
        <motion.path className="part-3" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="m5.594 8.209 2.615 3.403a1 1 0 0 0 1.75-.329l1.567-5.34" />
        <motion.path className="part-4" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} d="M7 18 4 9" />
        <motion.circle className="part-5" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} cx="12" cy="4" r="2" />
        <motion.circle className="part-6" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} cx="20" cy="7" r="2" />
        <motion.circle className="part-7" style={{ transformOrigin: "50% 50%", transformBox: "fill-box" }} cx="4" cy="7" r="2" />
      </motion.svg>
    );
  },
);
