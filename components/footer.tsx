      ...
      <div className="mx-auto max-w-5xl px-6 py-12">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2">
          <div>
            ...
            <Link
              href="/icons"
              className="mt-6 inline-flex items-center rounded-full border border-zinc-950 bg-white px-4 py-1.5 text-sm font-medium text-zinc-800 transition-colors hover:bg-zinc-950 hover:text-white dark:border-zinc-200 dark:bg-zinc-950 dark:text-zinc-100 dark:hover:bg-white dark:hover:text-zinc-950"
            >
